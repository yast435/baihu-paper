...
\textbf{Baihu v2.0} & \textbf{513.6k} & \textbf{2989} & \textbf{4} \\
\bottomrule
\end{tabular}
\end{adjustbox}
\end{table}

Table~\ref{tab:dataset-comparison} highlights Baihu's scale in terms of episode count and task coverage. Baihu v2.0 contains 513,575 episodes across 2989 tasks, and the current dataset statistics identify four skill categories.
