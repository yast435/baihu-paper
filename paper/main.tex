...
\begin{table}[t]
\centering
\caption{Comparison with representative robot manipulation datasets. Public dataset numbers are listed according to the cited papers.}
\label{tab:dataset-comparison}
\footnotesize
\setlength{\tabcolsep}{4pt}
\renewcommand{\arraystretch}{1.15}
\begin{adjustbox}{max width=\textwidth}
\begin{tabular}{p{0.24\textwidth}p{0.25\textwidth}p{0.28\textwidth}p{0.19\textwidth}}
\toprule
...
\textbf{Baihu v2.0} & \textbf{Yes} & \textbf{9521.75 hours, 1.03B frames, 14 embodiment tags} & \textbf{2989 tasks} \\
\bottomrule
\end{tabular}
\end{adjustbox}
\end{table}
